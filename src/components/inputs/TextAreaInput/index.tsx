    ...
    return (
      <div className="w-full flex flex-col h-[200px]">
        ...
        <textarea
          ...
          className="w-full flex flex-1 text-gray-700 border-2 rounded-lg focus:border-blue-700 focus:border-3 focus:outline-none bg-white dark:bg-slate-700 dark:text-gray-100 p-4 resize-none placeholder-custom"
          ref={ref}
          {...rest}
        />
        {showTextLength && (
